...
def main() -> None:
    ...
    # Start the Bot using local machine
    # updater.start_polling()

    # start the bot using heroku
    updater.start_webhook(listen="0.0.0.0",
                          port=PORT,
                          url_path=TOKEN,
                          webhook_url="https://booksgram-bot.herokuapp.com/" + TOKEN)
    #updater.bot.setWebhook('https://booksgram-bot.herokuapp.com/' + TOKEN)
